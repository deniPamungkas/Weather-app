...
function App() {
  ...
  const getBackground = () => {
    if(datan.desc === "scattered clouds" || datan.desc === "broken clouds"){
      return cloud1
    }else if(datan.desc === "overcast clouds"){
      return cloud2
    }else if(datan.desc === "rain"){
      return rain
    }else{
      return sun
    }
  ...
  return (
    <div className="App">
    <img className="background" src={getBackground()} alt="background"/>
